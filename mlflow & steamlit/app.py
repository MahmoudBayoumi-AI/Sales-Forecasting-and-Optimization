...
model_uri = "runs:/82fdbd198fda466a88ec62a7610df0a2/catboost_model"
...
# Prediction button
if st.button("Predict Item_Outlet_Sales"):
    ...
    st.success(f"Predicted Item_Outlet_Sales: {prediction[0]:.2f}")
